# Generated by Django 2.0.4 on 2018-08-16 05:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(blank=True, null=True, upload_to='comment_thumbnail/%Y/%m/%d/', verbose_name='サムネイル')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('src', models.FileField(upload_to='files/%Y/%m/%d/', verbose_name='添付ファイル')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, verbose_name='リンク')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_view', models.ImageField(upload_to='', verbose_name='ページビュー数')),
            ],
        ),
        migrations.CreateModel(
            name='Post',
            fields=[
                ...
                ('is_public', models.BooleanField(default=True, verbose_name='公開可否')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='名無し', max_length=20, verbose_name='名前')),
                ('text', models.TextField(verbose_name='返信')),
                ('icon', models.ImageField(blank=True, null=True, upload_to='recomment_thumbnail/%Y/%m/%d/', verbose_name='サムネイル')),
                ('created_at', models.DateTimeField(auto_now=True, verbose_name='作成日')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(default='タイトル', max_length=255, verbose_name='タイトル')),
                ('heaer_text', models.TextField(default='paleolithic !!', max_length=255, verbose_name='ヘッダーテキスト')),
                ('description', models.TextField(default='説明', max_length=255, verbose_name='サイト説明')),
                ('author', models.CharField(default='muscle', max_length=255, verbose_name='管理人')),
                ('author_mail', models.EmailField(default='muscle@gmail.com', max_length=254, verbose_name='メールアドレス')),
