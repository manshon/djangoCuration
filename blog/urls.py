...
urlpatterns = [
    ...
    path('contact_mail/', views.ContactMailListView.as_view(), name='contact_mail'),
    path('contact_mail/<int:pk>', views.ContactMailDetailView.as_view(), name='contact_mail_detail'),
